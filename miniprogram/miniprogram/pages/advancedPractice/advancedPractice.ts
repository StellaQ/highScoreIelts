...
import { getLeftList, getFilteredTagIdsToday, getTagList} from '../../utils/onloadDataAdvanced.js'; 
  ...
  async getExamQuestions() {
    try {
      ...
      const mockQuestions = [
        ...
        { text: "How do you think technology has changed the way we communicate?" },
        { text: "What do you think about the future of artificial intelligence?" },
        { text: "How can we balance work and personal life?" },
        { text: "What are the main environmental challenges facing our planet today?" }
      ];
