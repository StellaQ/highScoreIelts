...
router.get('/getCategories', async (req, res) => {
  ...
  try {
    // 读取categories.json文件
    const categoriesPath = path.join(__dirname, '../data_for_server/archive/expert/categories.json');
